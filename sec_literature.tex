...
This section consists of research papers focused on these main topics: 
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Survey papers that describe the state-of-art techniques (\cref{sec:lit_review}).
        \item Comparative studies evaluating different methods (\cref{sec:comparative_studies}).
    \end{itemize}
    \item \textit{Bug prediction}: ranks higher the alerts in problematic parts of code (\cref{sec:bug_prediction}).
    \item Examples on \textit{real world usage of SA tools}, its problems and solutions (\cref{sec:tools_practice})
\end{itemize}
...
%     \end{subfigure}
     \caption{Feedback-Rank clustering of alerts}
 \end{figure}
 ...
 \begin{figure}[H]
     ...
     \begin{subfigure}{0.5\textwidth}
         \centering
         \includegraphics[scale=0.3]{./src/which_warnings_results.png}
         \caption{Line marking approach}\label{which_warnings:results}
     \end{subfigure}
      \caption{HWP algorithm and results}
 \end{figure}
 ...
 \begin{figure}[H]
     ...
     \end{subfigure}
 	 \caption{Actionable Alerts with Logistic Regression}
 \end{figure}
...
% \end{figure}
 ...
 \begin{figure}[H]
     ...
     \begin{subfigure}{0.5\textwidth}
         ...
         \end{subfigure}
     \end{subfigure}
 	 \caption{Automatic construction of an effective training set}
 \end{figure}
 ...
 \begin{figure}[H]
     ...
     \end{subfigure}
 	 \caption{Prioritizing alerts from multiple SA}
 \end{figure}
 ...
 \begin{figure}[H]
     ...
     \end{subfigure}
     \caption{Ranking warnings from mulitple SA via ensemble learning}
 \end{figure}
 ...
 \begin{figure}[H]
     \begin{subfigure}{0.45\textwidth}
         \centering
         \includegraphics[scale=0.35]{./src/survey_sa_papers.png}
         \caption{Number of relevant papers per year and category}\label{survey:papers}
     \end{subfigure}%
     \begin{subfigure}{0.55\textwidth}
         \centering
         \includegraphics[scale=0.3]{./src/survey_sa_categories.png}
         \caption{Summary of the approaches}\label{survey:categories}
     \end{subfigure}
 	 \caption{Survey of approaches for handling SA alerts}
 \end{figure}
...
%     \end{subfigure}
% 	 \caption{Mining metrics to predict component failures}
% \end{figure}
 ...
 \begin{figure}[H]
    \begin{subfigure}{\textwidth}
     ...
     \end{subfigure}\\
 	 \caption{Method level bug prediction}
 \end{figure}
...
% \end{figure}
 ...
 \begin{figure}[H]
     ...
     \begin{subfigure}{0.5\textwidth}
         \centering
         \includegraphics[scale=0.3]{./src/sa_analysis_survey_changes.png}
         \caption{Changes in configuration of SA tools}\label{sa_analysis_survey:changes}
     \end{subfigure}
 	 \caption{Analyzing the state of static analysis}
 \end{figure}
 ...
 \begin{figure}[H]
     ...
     \end{subfigure}
  	 \caption{How do developers act on SA alerts?}
 \end{figure}
 ...
 \begin{figure}[H]
     ...
     \end{subfigure}
  	 \caption{How many of all bugs do we find?}
 \end{figure}
