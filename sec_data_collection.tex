...
The different techniques that were tested are: \henrique{I do not see what this has to do with Data Collection? The list below seems more like a methodology for your ranking, which would be more appropriate for Section 5.}
\begin{itemize}
